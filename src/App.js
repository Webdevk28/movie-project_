          ...
          <div id="mySidepanel" className="menu md:w-9/12">
            <div className="flex flex-col justify-start md:justify-end md:items-center md:flex-row text-md md:text-sm leading-5 p-4 gap-3 tracking-wider">
              <div className="flex flex-col justify-start tracking-wider md:flex-row gap-5 mt-8 md:mt-0 md:gap-8 md:px-5 font-semibold">
                <Link className="text-left link link-underline py-1.5" to={"/"}> MOVFLIX </Link>
                <Link className="text-left link link-underline py-1.5" to={"/Movie"} > MOVIE </Link>
                <Link className="text-left link link-underline py-1.5" to={"/Tvshow"} > TV SHOW </Link>
                <Link className="text-left link link-underline py-1.5" to={"/Pricingplan"} > PRICING </Link>
              </div>

              <div className="flex mt-5 md:mt-0">
                <Link className="px-8 py-1.5 shadow-sm shadow-yellow-200/50 bg-gray-900 text-yellow-200 rounded-lg hover:bg-gray-800 duration-50 tracking-wide"to={"/Login"} >
                  LOGIN
                </Link>
              </div>
            </div>
